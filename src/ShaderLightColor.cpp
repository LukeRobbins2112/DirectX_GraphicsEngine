...
ShaderLightColor::ShaderLightColor(ID3D11Device* dev)
	: ShaderBase(dev, L"../Assets/Shaders/LightColor.hlsl")
{
...
ShaderLightColor::~ShaderLightColor()
{
...
void ShaderLightColor::SendCamMatrices(const Matrix& view, const Matrix& proj)
{
...
void ShaderLightColor::SetDirectionalLightParameters(const Vect& dir, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderLightColor::SetPointLightParameters(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderLightColor::SetSpotLightParameters(const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderLightColor::SetFogParams(float fogStart, float fogRange, Vect fogColor) {
	FData.FogStart = fogStart;
	FData.FogRange = fogRange;
	FData.FogColor = fogColor;
}

void ShaderLightColor::SendFogParameters() {
...
void ShaderLightColor::SendLightParameters( const Vect& eyepos)
{
	Data_LightParams dl;
...
void ShaderLightColor::SendWorldAndMaterial(const Matrix& world, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderLightColor::SetToContext(ID3D11DeviceContext* devcon)
{
